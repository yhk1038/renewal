...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { background_img: @theme.background_img, thumbnail_img: @theme.thumbnail_img, title: @theme.title } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { background_img: @theme.background_img, thumbnail_img: @theme.thumbnail_img, title: @theme.title } }
